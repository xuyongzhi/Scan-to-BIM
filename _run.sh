...
wkdir=R50_fpn_refine_final_beike_pcl_2d_bs7_lr10_Daug_Rfiou743_Fpn34_Pbs1_Bp32_Vsz8Stem2
...
#./tools/dist_train.sh ${CONFIG} 2 --rotate $ROTATE --cls $CLS --corhm $CORHM --dcn_zero_base $DCN_ZERO_BASE --lr 0.01 --base_plane $BASE_PLANE --resume $CP 
