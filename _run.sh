...
CONFIG=configs/strpoints/strpoints_r50_fpn_1x_loss.py
CONFIG=configs/strpoints/strpoints_r50_fpn_1x_iou.py
#CONFIG=configs/strpoints/pcl_dense3dfpn_strpoints_r50_fpn_1x.py


wkdir=TPV_r50_fpn_beike2d_wa_bs7_lr10_LsW510_RAR2P1N1_Rfiou844_Fpn44_Pbs1_Bp32_Fe-D90_0K_zX
CP=./work_dirs/${wkdir}/best.pth
#CONFIG=./work_dirs/${wkdir}/_pcl_dense3dfpn_strpoints_r50_fpn_1x.py
CONFIG=./work_dirs/${wkdir}/_strpoints_r50_fpn_1x_iou.py
