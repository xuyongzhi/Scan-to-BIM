...
class BEIKE(BEIKE_CLSINFO):
    ...
    def show_anno_img(self, idx,  with_img=True, rotate_angle=0, lines_transfer=(0,0,0)):
      ...
      _show_objs_ls_points_ls(
                               img, [bboxes], obj_rep = self.obj_rep,
                               points_ls = [corners],
...
def raw_anno_to_img(obj_rep, anno_raw, anno_style, pixel_config):
      ...
      #_show_objs_ls_points_ls((512,512), [lines_pt.reshape(-1,4)], 'RoLine2D_2p')
      #_show_objs_ls_points_ls((512,512), [lines_pt_ordered], obj_rep)
      return anno_img
