...
class UNET_Dense3D(nn.Module):
    ...
    def __init__(self,
        ...
        super(UNET_Dense3D, self).__init__()
    ...
    def forward(self, inputs):
        ...
        if SHOW_NET and 1:
          print('\n\n')
          _show_tensor_ls_shapes(inputs, ' UNET_Dense3D inputs')
        ...
        if SHOW_NET and 1:
          print('\n\n')
          _show_tensor_ls_shapes(outs, 'UNET_Dense3D outs')
          print('\n\n')
