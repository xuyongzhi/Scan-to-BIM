...
#wkdir=R50_fpn_refine_final_beike_pcl_2d_bs5_lr10_Rfiou743_Fpn35_Pbs1_Bp32_Vsz8_Asv
...
#ipython tools/test.py --  ${CONFIG} $CP --rotate $ROTATE --cls $CLS --corhm $CORHM --dcn_zero_base $DCN_ZERO_BASE $STYLE --base_plane $BASE_PLANE  --auto_scale_vs $AUTO_SCALE_VS
