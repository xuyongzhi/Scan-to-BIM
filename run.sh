...
#CONFIG=${wkdir}/_pcl_strpoints_r50_fpn_1x.py
...
ipython tools/train.py --  ${CONFIG} --rotate $ROTATE --cls $CLS --corhm $CORHM --dcn_zero_base $DCN_ZERO_BASE  --lr 0.01 --base_plane $BASE_PLANE   --bs 2
#--resume $CP 
